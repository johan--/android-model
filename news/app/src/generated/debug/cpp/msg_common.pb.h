...
class PhoneCaptchaRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:personal.PhoneCaptchaRequest) */ {
 ...
 private:
  ...
  friend void  protobuf_InitDefaults_msg_5fcommon_2eproto_impl();
  friend void  protobuf_AddDesc_msg_5fcommon_2eproto_impl();
  friend void protobuf_AssignDesc_msg_5fcommon_2eproto();
  friend void protobuf_ShutdownFile_msg_5fcommon_2eproto();
