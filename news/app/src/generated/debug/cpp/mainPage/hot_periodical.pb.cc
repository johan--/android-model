...
void protobuf_AssignDesc_mainPage_2fhot_5fperiodical_2eproto() GOOGLE_ATTRIBUTE_COLD;
void protobuf_AssignDesc_mainPage_2fhot_5fperiodical_2eproto() {
  protobuf_AddDesc_mainPage_2fhot_5fperiodical_2eproto();
  const ::google::protobuf::FileDescriptor* file =
    ::google::protobuf::DescriptorPool::generated_pool()->FindFileByName(
      "mainPage/hot_periodical.proto");
...
void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_mainPage_2fhot_5fperiodical_2eproto);
}
...
void protobuf_ShutdownFile_mainPage_2fhot_5fperiodical_2eproto() {
...
void protobuf_InitDefaults_mainPage_2fhot_5fperiodical_2eproto_impl() {
...
GOOGLE_PROTOBUF_DECLARE_ONCE(protobuf_InitDefaults_mainPage_2fhot_5fperiodical_2eproto_once_);
void protobuf_InitDefaults_mainPage_2fhot_5fperiodical_2eproto() {
  ::google::protobuf::GoogleOnceInit(&protobuf_InitDefaults_mainPage_2fhot_5fperiodical_2eproto_once_,
                 &protobuf_InitDefaults_mainPage_2fhot_5fperiodical_2eproto_impl);
}
void protobuf_AddDesc_mainPage_2fhot_5fperiodical_2eproto_impl() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  protobuf_InitDefaults_mainPage_2fhot_5fperiodical_2eproto();
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    " \001(\tB\022\n\020com.wanfang.mainb\006proto3", 272);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "mainPage/hot_periodical.proto", &protobuf_RegisterTypes);
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_mainPage_2fhot_5fperiodical_2eproto);
}

GOOGLE_PROTOBUF_DECLARE_ONCE(protobuf_AddDesc_mainPage_2fhot_5fperiodical_2eproto_once_);
void protobuf_AddDesc_mainPage_2fhot_5fperiodical_2eproto() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AddDesc_mainPage_2fhot_5fperiodical_2eproto_once_,
                 &protobuf_AddDesc_mainPage_2fhot_5fperiodical_2eproto_impl);
}
// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_mainPage_2fhot_5fperiodical_2eproto {
  StaticDescriptorInitializer_mainPage_2fhot_5fperiodical_2eproto() {
    protobuf_AddDesc_mainPage_2fhot_5fperiodical_2eproto();
  }
} static_descriptor_initializer_mainPage_2fhot_5fperiodical_2eproto_;
...
PeriodicalRequest::PeriodicalRequest()
  ...
  if (this != internal_default_instance()) protobuf_InitDefaults_mainPage_2fhot_5fperiodical_2eproto();
  SharedCtor();
