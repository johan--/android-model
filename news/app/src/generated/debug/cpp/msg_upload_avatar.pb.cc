...
void protobuf_AssignDesc_msg_5fupload_5favatar_2eproto() GOOGLE_ATTRIBUTE_COLD;
void protobuf_AssignDesc_msg_5fupload_5favatar_2eproto() {
  protobuf_AddDesc_msg_5fupload_5favatar_2eproto();
  const ::google::protobuf::FileDescriptor* file =
    ::google::protobuf::DescriptorPool::generated_pool()->FindFileByName(
      "msg_upload_avatar.proto");
...
void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_msg_5fupload_5favatar_2eproto);
}
...
void protobuf_InitDefaults_msg_5fupload_5favatar_2eproto_impl() {
...
GOOGLE_PROTOBUF_DECLARE_ONCE(protobuf_InitDefaults_msg_5fupload_5favatar_2eproto_once_);
void protobuf_InitDefaults_msg_5fupload_5favatar_2eproto() {
  ::google::protobuf::GoogleOnceInit(&protobuf_InitDefaults_msg_5fupload_5favatar_2eproto_once_,
                 &protobuf_InitDefaults_msg_5fupload_5favatar_2eproto_impl);
}
void protobuf_AddDesc_msg_5fupload_5favatar_2eproto_impl() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  protobuf_InitDefaults_msg_5fupload_5favatar_2eproto();
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "msg_upload_avatar.proto", &protobuf_RegisterTypes);
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_msg_5fupload_5favatar_2eproto);
}

GOOGLE_PROTOBUF_DECLARE_ONCE(protobuf_AddDesc_msg_5fupload_5favatar_2eproto_once_);
void protobuf_AddDesc_msg_5fupload_5favatar_2eproto() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AddDesc_msg_5fupload_5favatar_2eproto_once_,
                 &protobuf_AddDesc_msg_5fupload_5favatar_2eproto_impl);
}
// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_msg_5fupload_5favatar_2eproto {
  StaticDescriptorInitializer_msg_5fupload_5favatar_2eproto() {
    protobuf_AddDesc_msg_5fupload_5favatar_2eproto();
  }
} static_descriptor_initializer_msg_5fupload_5favatar_2eproto_;
...
UploadAvatarRequest::UploadAvatarRequest()
  ...
  if (this != internal_default_instance()) protobuf_InitDefaults_msg_5fupload_5favatar_2eproto();
  SharedCtor();
