...
void protobuf_AssignDesc_meeting_5fmessage_2eproto() GOOGLE_ATTRIBUTE_COLD;
void protobuf_AssignDesc_meeting_5fmessage_2eproto() {
  protobuf_AddDesc_meeting_5fmessage_2eproto();
  const ::google::protobuf::FileDescriptor* file =
    ::google::protobuf::DescriptorPool::generated_pool()->FindFileByName(
      "meeting_message.proto");
...
void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_meeting_5fmessage_2eproto);
}
...
void protobuf_InitDefaults_meeting_5fmessage_2eproto_impl() {
...
GOOGLE_PROTOBUF_DECLARE_ONCE(protobuf_InitDefaults_meeting_5fmessage_2eproto_once_);
void protobuf_InitDefaults_meeting_5fmessage_2eproto() {
  ::google::protobuf::GoogleOnceInit(&protobuf_InitDefaults_meeting_5fmessage_2eproto_once_,
                 &protobuf_InitDefaults_meeting_5fmessage_2eproto_impl);
}
void protobuf_AddDesc_meeting_5fmessage_2eproto_impl() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  protobuf_InitDefaults_meeting_5fmessage_2eproto();
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "anfang.mainb\006proto3", 219);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "meeting_message.proto", &protobuf_RegisterTypes);
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_meeting_5fmessage_2eproto);
}

GOOGLE_PROTOBUF_DECLARE_ONCE(protobuf_AddDesc_meeting_5fmessage_2eproto_once_);
void protobuf_AddDesc_meeting_5fmessage_2eproto() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AddDesc_meeting_5fmessage_2eproto_once_,
                 &protobuf_AddDesc_meeting_5fmessage_2eproto_impl);
}
// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_meeting_5fmessage_2eproto {
  StaticDescriptorInitializer_meeting_5fmessage_2eproto() {
    protobuf_AddDesc_meeting_5fmessage_2eproto();
  }
} static_descriptor_initializer_meeting_5fmessage_2eproto_;
...
MeetingRequest::MeetingRequest()
  ...
  if (this != internal_default_instance()) protobuf_InitDefaults_meeting_5fmessage_2eproto();
  SharedCtor();
