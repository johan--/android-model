...
#ifndef PROTOBUF_msg_5fmy_5forders_2eproto__INCLUDED
#define PROTOBUF_msg_5fmy_5forders_2eproto__INCLUDED
...
class MyOrdersRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:personal.MyOrdersRequest) */ {
 ...
 private:
  ...
  friend void  protobuf_InitDefaults_msg_5fmy_5forders_2eproto_impl();
  friend void  protobuf_AddDesc_msg_5fmy_5forders_2eproto_impl();
  friend void protobuf_AssignDesc_msg_5fmy_5forders_2eproto();
  friend void protobuf_ShutdownFile_msg_5fmy_5forders_2eproto();
...
class MyOrdersResponse_Result : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:personal.MyOrdersResponse.Result) */ {
 public:
  ...
  const ::std::string& order_state() const;
  void set_order_state(const ::std::string& value);
  void set_order_state(const char* value);
  void set_order_state(const char* value, size_t size);
  ::std::string* mutable_order_state();
  ::std::string* release_order_state();
  void set_allocated_order_state(::std::string* order_state);
 ...
 private:
  ...
  ::google::protobuf::internal::ArenaStringPtr order_state_;
...
inline const ::std::string& MyOrdersResponse_Result::order_state() const {
...
inline void MyOrdersResponse_Result::set_order_state(const ::std::string& value) {
...
inline void MyOrdersResponse_Result::set_order_state(const char* value) {
...
inline void MyOrdersResponse_Result::set_order_state(const char* value, size_t size) {
...
inline ::std::string* MyOrdersResponse_Result::mutable_order_state() {
...
inline ::std::string* MyOrdersResponse_Result::release_order_state() {
...
inline void MyOrdersResponse_Result::set_allocated_order_state(::std::string* order_state) {
  if (order_state != NULL) {
...
#endif  // PROTOBUF_msg_5fmy_5forders_2eproto__INCLUDED
