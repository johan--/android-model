...
void protobuf_AssignDesc_mainPage_2fall_5fproject_2eproto() GOOGLE_ATTRIBUTE_COLD;
void protobuf_AssignDesc_mainPage_2fall_5fproject_2eproto() {
  protobuf_AddDesc_mainPage_2fall_5fproject_2eproto();
  const ::google::protobuf::FileDescriptor* file =
    ::google::protobuf::DescriptorPool::generated_pool()->FindFileByName(
      "mainPage/all_project.proto");
...
void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_mainPage_2fall_5fproject_2eproto);
}
...
void protobuf_InitDefaults_mainPage_2fall_5fproject_2eproto_impl() {
...
GOOGLE_PROTOBUF_DECLARE_ONCE(protobuf_InitDefaults_mainPage_2fall_5fproject_2eproto_once_);
void protobuf_InitDefaults_mainPage_2fall_5fproject_2eproto() {
  ::google::protobuf::GoogleOnceInit(&protobuf_InitDefaults_mainPage_2fall_5fproject_2eproto_once_,
                 &protobuf_InitDefaults_mainPage_2fall_5fproject_2eproto_impl);
}
void protobuf_AddDesc_mainPage_2fall_5fproject_2eproto_impl() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  protobuf_InitDefaults_mainPage_2fall_5fproject_2eproto();
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "com.wanfang.mainb\006proto3", 224);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "mainPage/all_project.proto", &protobuf_RegisterTypes);
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_mainPage_2fall_5fproject_2eproto);
}

GOOGLE_PROTOBUF_DECLARE_ONCE(protobuf_AddDesc_mainPage_2fall_5fproject_2eproto_once_);
void protobuf_AddDesc_mainPage_2fall_5fproject_2eproto() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AddDesc_mainPage_2fall_5fproject_2eproto_once_,
                 &protobuf_AddDesc_mainPage_2fall_5fproject_2eproto_impl);
}
// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_mainPage_2fall_5fproject_2eproto {
  StaticDescriptorInitializer_mainPage_2fall_5fproject_2eproto() {
    protobuf_AddDesc_mainPage_2fall_5fproject_2eproto();
  }
} static_descriptor_initializer_mainPage_2fall_5fproject_2eproto_;
...
ProjectRequest::ProjectRequest()
  ...
  if (this != internal_default_instance()) protobuf_InitDefaults_mainPage_2fall_5fproject_2eproto();
  SharedCtor();
