...
public class MyOrderAdapter extends BaseQuickAdapter<MsgMyOrders.MyOrdersResponse.Result, BaseViewHolder> {


    public MyOrderAdapter(@Nullable List<MsgMyOrders.MyOrdersResponse.Result> data) {
        super(R.layout.item_my_order, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, MsgMyOrders.MyOrdersResponse.Result item) {
