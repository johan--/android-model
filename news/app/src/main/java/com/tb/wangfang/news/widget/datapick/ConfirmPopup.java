package com.tb.wangfang.news.widget.datapick;
...
public abstract class ConfirmPopup<V extends View> extends BasicPopup<View> {
    ...
    protected View makeHeaderView() {
        ...
        int height = SystemUtil.dp2px(activity, topHeight);
        ...
        int padding = SystemUtil.dp2px(activity, topPadding);
        cancelButton.setPadding(padding, 0, padding, 0);
        if (!TextUtils.isEmpty(cancelText)) {
            cancelButton.setText(cancelText);
        }
        cancelButton.setTextColor(SystemUtil.toColorStateList(cancelTextColor, pressedTextColor));
        if (cancelTextSize != 0) {
        ...
        if (null == titleView) {
            ...
            int margin = SystemUtil.dp2px(activity, topPadding);
        ...
        submitButton.setTextColor(SystemUtil.toColorStateList(submitTextColor, pressedTextColor));
        if (submitTextSize != 0) {
