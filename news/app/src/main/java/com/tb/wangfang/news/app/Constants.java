...
public class Constants {
    ...
    //1.4.热搜词查询
    public static final String HOT_SEARCH_WORDS = BASE_URL + "app/searchhotwords.do?theme=&type=&field=&themeState=&user_id=&user_type=&page=1&pageSize=10&sortField=&startDate=&endDate=";
    //详情页查询
